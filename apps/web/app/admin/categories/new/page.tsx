  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-display font-bold text-[var(--text-primary)]">Kategori Baru</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="text" value={form.icon} onChange={(e) => setForm((p) => ({ ...p, icon: e.target.value }))} className="input" placeholder="📚" maxLength={10} />
          </div>
        </div>
        <div>
